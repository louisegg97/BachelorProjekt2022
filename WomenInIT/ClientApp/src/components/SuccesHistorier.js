...
import GraceHopper from './images/SuccesHistorier/graceHopper.jpg';
    ...
    return (
      <div>
        ...
        <div className="topDiv">
          ...
          <div className="billedeDiv">
          <img className="billede7" src={GraceHopper} alt=""/>
        ...
        <div className="historieOrange">
          <h1 className="overskriftHøjre">Grace Hopper</h1>
          <div className="indhold">
            ...
            <img className="billede" src={GraceHopper} alt=""/>
          </div>
        </div>

      ...
      <div>
        ...
        <div className="historieOrange">
          ...
          <div className="indhold">
            <p className="beskrivelseLys"> Ada Lovelace er blevet kaldt verdens første computerprogrammør. 
              ...
              Lovelaces notater gjorde det klart, at hun forstod den analytiske motor lige så godt som som Babbage selv. 
        ...
        <div id="id-of-div" className="historiePink">
          ...
          <div className="indhold">
            ...
            Hun var en del af holdet, der skabte Star Raiders til Atari 2600. 
        ...
        <div className="historieLys">
          ...
          <div className="indhold">
            ...
            <p className="beskrivelseMørk"> Dona Bailey var den første kvindelige programmør i coin-op afdelingen hos Atari, da hun blev ansat i 1980. 
              ...
              Der var kun gået lidt over en måned, siden hun flyttede nordpå i slutningen af april og derefter begyndte hun at arbejde hos Atari i den første uge af juni 1980.
        ...
        <div id="id-of-div" className="historiePink">
          ...
          <div className="indhold">
            <p className="beskrivelseLys"> Louise Barkhuus er professor ved IT-Universitetet (siden juli 2021, lektor fra september 2016), 
             ...
             Et af hendes store projekter (2022-2024) er ReWork under DIREC-rammen; hendes kolleger og hende modtog for nylig en stor bevilling på fire universiteter for at se på fremtiden for hybridarbejde. 
             Louise Barkhuus modtog også for nylig en bevilling med fokus på privatliv i multikulturelle omgivelser, med kolleger i USA.
              I løbet af 2015 og 2016 var hun gæsteprofessor ved Cornell Tech. 
              ...
              Mellem 2012 og 2016 var hun lektor ved Stockholm Universitet, Afdelingen for Computer- og Systemvidenskab hvor hun også var leder af ACT-forskningsenheden. 
              ...
              På UCSD (2007-2011) var hun hovedefterforsker på et NSF-finansieret projekt: "Transforming Social Science Virtual Organisations". 
              ...
              De har for nylig udviklet TagPad, et værktøj til at interviewe deltagere og analysere samfundsvidenskabelige studier.
        ...
        <div className="historieOrange">
          ...
          <div className="indhold">
            <p className="beskrivelseLys"> I 1965 var Mary Kenneth Keller den første kvinde i USA, der blev tildelt en ph.d. i datalogi, efter at have studeret matematik og fysik. 
              ...
              Det er et programmeringssprog på højt niveau til generelle formål, det hjalp med at udvide computerprogrammering til ikke-matematiske og naturvidenskabelige områder, hvilket efterfølgende gav mange mennesker deres første erfaring med programmering.
        ...
        <div className="historieLys">
          ...
          <div className="indhold">
            ...
            <p className="beskrivelseMørk"> Pernille Bjørn er professor på Datalogisk Institut ved Københavns Universitet, hvor hun også er viceinstitutleder for forskning. 
              ...
              Ud over sit projekt med at løfte datalogihistoriens kvinder frem og give dem behørig credit for deres bidrag til faget, har Pernille Bjørn også arbejdet for at ændre ved den skæve kønsbalance på sit institut.
        ...
        <div id="id-of-div" className="historiePink">
          ...
          <div className="indhold">
            <p className="beskrivelseLys"> Plamena Cherneva er, som navnet antyder, ikke dansker, men fra Bulgarien. 
              ...
              Her var hun igen den eneste kvinde, der arbejdede med kodning. De to andre kvinder var ansat i marketing.
        ...
        <div className="historieLys">
          ...
          <div className="indhold">
            ...
            <p className="beskrivelseMørk"> Suki Lee er en banebrydende kvindelig videospiludvikler, softwareingeniør og succesfuld projektleder.
              ...
              Suki blev ansat til at skabe pædagogiske spil, og som en førstegenerations immigrant fra Hong Kong, var hun opdraget til at få et godt job, og med hypen om hjemmevideospil på det tidspunkt virkede Atari som et godt valg. 

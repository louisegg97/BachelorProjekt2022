      ...
      return (
        <div>
          <Link to="/Opgaver" className="tilbage">Tilbage</Link>
            ...
            <p className="intro">
            Her har du mulighed for at prøve kræfter med at programmere front-end selv. Vi mener, at det er vigtigt at opleve programmering selv for at forstå, hvordan det virker, og hvad det kan. Vi har derfor lavet nogle opgaver, som du kan kaste dig ud i, uanset hvor meget erfaring du har med programmering. Hvis du ønsker at læse mere om front-end, kan du gøre det i “Om programmering”.
            <br /> <br />
